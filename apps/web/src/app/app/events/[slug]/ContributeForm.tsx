...
/** Brief delay before first poll so the provider has time to register the reference. */
        ...
        <div className="p-6">
          ...
          <p className="text-muted text-sm mb-4">
            {lastStatus === "pledged"
              ...
              : lastPaidViaMomo
                ? `Your payment of UGX ${numAmount.toLocaleString()} was received ${paymentReceivedViaPhrase(paymentProcessorKind)}.`
